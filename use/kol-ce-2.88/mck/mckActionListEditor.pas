...
{$ifdef FPC}
    GlobalDesignHook.SelectOnlyThis(Act);
{$else}
...
var I: Integer;
    ...
    AL: TKOLActionList;
begin
  lvActions{$ifndef FPC}.Items{$endif}.BeginUpdate;
  TRY
  ...
  FINALLY
    lvActions{$ifndef FPC}.Items{$endif}.EndUpdate;
  END;
end;
...
{$ifdef FPC}
  GlobalDesignHook.PersistentAdded(Act, False);
{$endif FPC}
...
begin
  GlobalDesignHook.SelectOnlyThis(FActionList);
end;
{$else Delphi}
procedure TfmActionListEditor.SelectLV;
var F: TForm;
